# Desarrollo Back End: TypeScript, Programación Orientada a Objetos, ExpressJS, API REST y CRUD
...
| **Clase 8** | lun, 10 nov 2025 | **Repaso:** Ejercicio práctico en vivo aplicando los 4 pilares de la POO. |

### Módulo 3: Asincronía

| Clase | Fecha | Temario |
| :--- | :--- | :--- |
| **Clase 9** | mié, 12 nov 2025 | **Introducción a la asincronía:** Sincronía vs Asincronía, setInterval(), setTimeout(). |
| **Clase 10** | lun, 17 nov 2025 | **Promesas, Event Loop y Callback:** Hilo de Ejecución, Loop de Eventos, Callbacks y Callback Hell, Promesas (then, catch, finally). |
| **Clase 11** | mié, 19 nov 2025 | **Async/Await y Try-catch:** Concurrencia y Paralelismo, Operaciones CPU-Bound vs I/O-Bound, Modelo de Javascript, Async/Await, Manejo de Errores con try/catch, Promise.all. |

### Módulo 4: Express y Api Rest

| Clase | Fecha | Temario |
| :--- | :--- | :--- |
| **Clase 12** | mié, 26 nov 2025 | **Solicitudes y Respuestas HTTP y Framework Express:** Protocolo HTTP (Solicitud y Respuesta), Frameworks (Front-End, Back-End, Full-Stack), Introducción a ExpressJS (End Point, REQ-RES, app, express.json). |
| **Clase 13** | lun, 1 dic 2025 | **Fetch, Routers, Postman:** Uso de Fetch para consumir APIs, Router Básico en Express, Introducción y uso de Postman. |
| **Clase 14** | mié, 3 dic 2025 | **API REST, Middlewares, ZOD, CORS:** Conceptos de API REST, Middlewares en Express, Validación con Zod, CORS (Cross-Origin Resource Sharing). |

### Módulo 5: Repaso y Profundización

| Clase | Fecha | Temario |
| :--- | :--- | :--- |
| **Clase 15** | mié, 10 dic 2025 | **Tokens:** ¿Qué es un token?, Tipos (sesión, JWT), Seguridad, Payload y Flujo de autenticación. |
| **Clase 16** | lun, 15 dic 2025 | **Sistema de logueo y Variables de Entorno:** Componentes y seguridad de un sistema de logueo, Variables de entorno (.env). |
| **Clase 17** | mié, 17 dic 2025 | **Deploy y producción:** Concepto de deploy, Ambientes (desarrollo, staging, producción), Elección de Hosting, Deploy Manual y Automatizado. |
| **Clase 18** | lun, 22 dic 2025 | **Repaso Blokeet y Router Básico:** Repaso práctico de creación de un router con un bloque de preguntas y respuestas. |
| **Clase 19** | lun, 5 ene 2026 | **Repaso de API REST y Express (Parte 1):** Endpoints, Métodos HTTP, Operaciones CRUD, req y res, Parámetros en rutas. |
| **Clase 20** | mié, 7 ene 2026 | **Repaso de Express, Postman, Seguridad y Buenas Prácticas (Parte 2):** Middlewares, Postman, Zod, CORS, Tokens (JWT), Sistema de logueo, Variables de entorno. |
| **Clase 21** | lun, 12 ene 2026 | **Repasamos Deploy y Producción:** Integración de front y back. |

### Módulo 6: Desafío Final

| Clase | Fecha | Temario |
| :--- | :--- | :--- |
| **Clase 22** | mié, 14 ene 2026 | **Desafío Final:** Presentación de la consigna del Trabajo Práctico Integrador. El docente estará disponible para resolver dudas. |
